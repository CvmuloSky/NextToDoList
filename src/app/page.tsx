...
export default function Home() {
  ...
  return (
    <div className="min-h-screen font-[family-name:var(--font-geist-sans)]">
      {/* Navbar is fixed so we add a div with top padding */}
      <Navbar />
      <div className="pt-20 grid grid-rows-[20px_1fr_20px] items-start justify-items-start p-8 pb-20 gap-16 sm:p-20">
        <main className="flex flex-col gap-8 items-start">
          ...
          <table className="mt-4 border-collapse border border-gray-300">
            <thead>
              <tr>
                <th className="border border-gray-300 p-2 bg-blue-300">
                  Task
                </th>
                <th className="border border-gray-300 p-2 bg-blue-300">
                  Class
